                  ...
                  <div className="card card-user-timeline">
                    <div className="card-header">
                      <div className="d-flex align-items-center">
                        <i
                          data-feather="list"
                          className="user-timeline-title-icon"
                        />
                      ...
                      <ul className="timeline ms-50">
                        ...
                        <li className="timeline-item">
                          ...
                          <div className="timeline-event">
                            ...
                            <p className="mb-0">
                              Update files as per new design
                            </p>
                          </div>
                        </li>
                      </ul>
                ...
                <div className="col-lg-4 col-md-6 col-12">
                  <div className="card card-app-design">
                    <div className="card-body">
                      ...
                      <h4 className="card-title mt-1 mb-75 pt-25">
                        App design
                      </h4>
                      <p className="card-text font-small-2 mb-2">
                        You can Find Only Post and Quotes Related to IOS like
                        ipad app design, iphone app design
                      </p>
