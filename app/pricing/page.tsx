                  ...
                  <div className="col-12 col-lg-10 col-lg-offset-3 mx-auto">
                    <div className="pricing-trial-content d-flex justify-content-between">
                      <div className="text-center text-md-start mt-3">
                        ...
                        <h5>
                          You will get full access to with all the features for
                          14 days.
                        </h5>
                        <button className="btn btn-primary mt-2 mt-lg-3">
                      ...
                      <div className="card accordion-item">
                        ...
                        >
                          <div className="accordion-body">
                            ...
                            gingerbread. Jelly beans chocolate pie powder.
                            Dessert pudding chocolate cake bonbon bear claw
                            cotton candy cheesecake. Biscuit fruitcake macaroon
                            carrot cake. Chocolate cake bear claw muffin chupa
                            chups pudding.
                          </div>
                        </div>
                      </div>
