            ...
            <div className="sidebar-menu-list">
              <div className="list-group list-group-messages">
                ...
                >
                  ...
                  <span className="badge badge-light-primary rounded-pill float-end">
                    3
                  </span>
                </a>
                ...
                <a href="#" className="list-group-item list-group-item-action">
                  ...
                  <span className="badge badge-light-warning rounded-pill float-end">
                    2
                  </span>
                </a>
                <a href="#" className="list-group-item list-group-item-action">
                ...
                <a href="#" className="list-group-item list-group-item-action">
                  ...
                  <span className="badge badge-light-danger rounded-pill float-end">
                    5
                  </span>
                </a>
                <a href="#" className="list-group-item list-group-item-action">
            ...
            <div className="app-action">
              <div className="action-left">
                <div className="form-check selectAll">
                  ...
                  />
                  <label
                    className="form-check-label fw-bolder ps-25"
                ...
                <ul className="list-inline m-0">
                  ...
                  <li className="list-inline-item">
                    <div className="dropdown">
                      ...
                      >
                        ...
                        <a href="#" className="dropdown-item">
                          <span className="me-50 bullet bullet-primary bullet-sm" />
                          Company
                        </a>
                        <a href="#" className="dropdown-item">
                  ...
                  <li className="list-inline-item mail-unread">
                    <span className="action-icon">
                      <i data-feather="mail" className="font-medium-2" />
                    </span>
                  </li>
                  <li className="list-inline-item mail-delete">
                    <span className="action-icon">
                      <i data-feather="trash-2" className="font-medium-2" />
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <ul className="email-media-list">
                  ...
                  <div className="mail-body">
                    ...
                    <div className="mail-message">
                      <p className="text-truncate mb-0">
                        ...
                        Argyroneta nonius veratrine preimaginary saunders
                        demidolmen Chaldaic allusiveness lorriker unworshipping
                        ribaldish tableman hendiadys outwrest unendeavored
                        fulfillment scientifical Pianokoto CheloniaFreudian
                        sperate unchary hyperneurotic phlogiston duodecahedron
                        unflown Paguridea catena disrelishable Stygian
                  ...
                  <div className="mail-body">
                    ...
                    <div className="mail-message">
                      <p className="mb-0 text-truncate">
                        Hi, Can we connect today? Cheesecake croissant jelly
                        beans. Cake caramels pie chocolate. Muffin jujubes
                        dragée carrot cake candy icing bonbon. Danish caramels
                        topping oat cake sweet roll liquorice tootsie roll
                        halvah.Chocolate bar jujubes jelly-o tart tiramisu
                        croissant dragée cupcake jelly.
                      </p>
                    </div>
                  </div>
                </li>
                <li className="d-flex user-mail mail-read">
                  ...
                  <div className="mail-body">
                    ...
                    <div className="mail-message">
                      <p className="mb-0 text-truncate">
                        Hi There, Cotton candy jujubes ice cream candy. Oat cake
                        jelly jelly brownie danish marzipan gummi bears. Cupcake
                        sweet bonbon tart. Sweet croissant jelly beans dragée
                        chocolate cake gingerbread topping chocolate bar lemon
                        drops.
                      </p>
                    </div>
                  </div>
                ...
                <li className="d-flex user-mail mail-read">
                  ...
                  <div className="mail-body">
                    ...
                    <div className="mail-message">
                      <p className="text-truncate mb-0">
                        Hello, Everything looks good. Pastry marshmallow sugar
                        plum. Gingerbread bonbon fruitcake gummi bears wafer
                        chocolate cake gummies tart ice cream. Danish topping
                        biscuit dessert donut dessert. Chocolate jelly-o topping
                        marzipan fruitcake.
                      </p>
                    </div>
                  </div>
                ...
                <li className="d-flex user-mail">
                  ...
                  <div className="mail-body">
                    ...
                    <div className="mail-message">
                      <p className="mb-0 text-truncate">
                        Hey John, Parthenopean logeion chipwood tonsilitic
                        cockleshell substance Stilbum dismayed tape Alderamin
                        Phororhacos bridewain zoonomia lujaurite printline
                        extraction weanedness charterless splitmouth bindoree
                        unfit philological Pythonissa scintillescentcinchonism
                        sabbaton thyrocricoid dissuasively schematograph immerse
                        pristane stimulability unreligion uncomplemental
                        uteritis nef bavenite Hachiman teleutosorus
                ...
                <li className="d-flex user-mail mail-read">
                  ...
                  <div className="mail-body">
                    ...
                    <div className="mail-message">
                      <p className="mb-0 text-truncate">
                        Hello Sir, Lituola restrengthen bathofloric manciple
                        decaffeinize Debby aciliated eatage proscribe
                        prejurisdiction buttle quacky hyposecretion
                        indemonstrableness schelling lymphopathy consumptivity
                        nonappointment filminess spumiform erotogenicity
                        equestrianize boneflower interlardationallocate ponzite
                        cote guilder tuff strind blamefully cocaine monstrously
                        apocalyptically sublanate cherubimical oligoplasmia
                        Miltonian hydrazyl unbeset statured Unami Cordeau
                ...
                <li className="d-flex user-mail mail-read">
                  ...
                  <div className="mail-body">
                    ...
                    <div className="mail-message">
                      <p className="mb-0 text-truncate">
                        Hi John, wartproof ketoheptose incomplicate hyomental
                        organal supermaterial monogene sophister nizamate
                        rightle multifilament phloroglucic overvehement
                        boatloading derelictly probudgeting archantiquary
                        unknighted pallograph Volcanalia Jacobitiana ethyl neth
                        Jugataenoumenalize irredential energeia phlebotomist
                        galp dactylitis unparticipated solepiece demure
                        metarhyolite toboggan unpleased perilaryngeal binoxalate
                        rabbitry atomic duali dihexahedron Pseudogryphus
                        boomboat obelisk
                      </p>
                    </div>
                  </div>
                ...
                <li className="d-flex user-mail mail-read">
                  ...
                  <div className="mail-body">
                    ...
                    <div className="mail-message">
                      <p className="mb-0 text-truncate">
                        Hi John,Biscuit lemon drops marshmallow. Cotton candy
                        marshmallow bear claw. Dragée tiramisu cookie cotton
                        candy. Carrot cake sweet roll I love macaroon wafer
                        jelly soufflé I love dragée. Jujubes jelly I love carrot
                        cake topping I love. Sweet candy I love
                      </p>
                    </div>
                  </div>
                </li>
                <li className="d-flex user-mail">
                  ...
                  <div className="mail-body">
                    ...
                    <div className="mail-message">
                      <p className="mb-0 text-truncate">
                        Hello John,Chocolate bar chupa chups sweet roll
                        chocolate muffin macaroon liquorice tart. Carrot cake
                        topping jelly-o cupcake sweet apple pie jelly I love.
                        Chocolate cake I love dessert carrot cake tootsie roll
                        chocolate I love. Tootsie roll pie marzipan sesame
                        snaps.
                      </p>
                    </div>
                  </div>
                ...
                <li className="d-flex user-mail mail-read">
                  ...
                  <div className="mail-body">
                    ...
                    <div className="mail-message">
                      <p className="mb-0 text-truncate">
                        Hi John,Biscuit lemon drops marshmallow. Marzipan carrot
                        cake soufflé. Toffee tiramisu pudding cotton candy
                        powder jujubes pie. Topping danish sweet croissant
                        liquorice lemon drops cake oat cake brownie. Cupcake
                        liquorice tart tootsie roll sugar plum chocolate bar oat
                        cake sweet roll.
                      </p>
                    </div>
                  </div>
          ...
          <div className="email-app-details">
            ...
            <div className="email-detail-header">
              <div className="email-header-left d-flex align-items-center">
                <span className="go-back me-1">
                  <i data-feather="chevron-left" className="font-medium-4" />
                </span>
              ...
              <div className="email-header-right ms-2 ps-1">
                <ul className="list-inline m-0">
                  <li className="list-inline-item">
                    <span className="action-icon favorite">
                  ...
                  <li className="list-inline-item">
                    <span className="action-icon">
                      <i data-feather="trash" className="font-medium-2" />
                    </span>
                  </li>
              ...
              <div className="row">
                <div className="col-12">
                  <div className="email-label">
                    <span className="mail-label badge rounded-pill badge-light-primary">
                      Company
                    </span>
                  </div>
                </div>
                    ...
                    <div className="card-body mail-message-wrapper pt-2">
                      <div className="mail-message">
                        ...
                        <p className="card-text">
                          ...
                          Stygian paleopsychology cantoris phosphoritic
                          disconcord fruited inblow somewhatly ilioperoneal
                          forrard palfrey Satyrinae outfreeman melebiose
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="mail-attachments">
                        <div className="d-flex align-items-center mb-1">
                          <i
                            ...
                            className="font-medium-1 me-50"
                          />
                          <h5 className="fw-bolder text-body mb-0">
                            2 Attachments
                          </h5>
                        </div>
              ...
              <div className="modal-content p-0">
                <div className="modal-header">
                  ...
                  <div className="modal-actions">
                    <a href="#" className="text-body me-75">
                      <i data-feather="minus" />
                    </a>
                    <a href="#" className="text-body me-75 compose-maximize">
                ...
                <div className="modal-body flex-grow-1 p-0">
                  <form className="compose-form">
                    <div className="compose-mail-form-field select2-primary">
                      ...
                      <div>
                        <a className="toggle-cc text-body me-1" href="#">
                          Cc
                        </a>
                        <a className="toggle-bcc text-body" href="#">
                          Bcc
                        </a>
                      </div>
                    </div>
                    <div className="compose-mail-form-field cc-wrapper">
                      ...
                      <a className="text-body toggle-cc" href="#">
                        <i data-feather="x" />
                      </a>
                    </div>
                    <div className="compose-mail-form-field bcc-wrapper">
                      ...
                      <a className="text-body toggle-bcc" href="#">
                        <i data-feather="x" />
                      </a>
                    </div>
                      ...
                      <div className="compose-editor-toolbar">
                        <span className="ql-formats me-0">
                          <select className="ql-font">
                            <option selected={true}>Sailec Light</option>
