      ...
      <section className="app-user-view-security">
        <div className="row">
          ...
          <div className="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
            ...
            <div className="card">
              <div className="card-body">
                <h4 className="card-title mb-50">Notifications</h4>
                <p className="mb-0">
                  Change to notification settings, the user will get the update
                </p>
              </div>
              <div className="table-responsive">
                <table className="table text-nowrap text-center border-bottom">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    <tr>
                      <td className="text-start">New for you</td>
                      <td>
                    ...
                    <tr>
                      <td className="text-start">Account activity</td>
                      <td>
                        <div className="form-check d-flex justify-content-center">
                          <input
                            className="form-check-input"
                    ...
                    <tr>
                      <td className="text-start">A new device is linked</td>
                      <td>
                        <div className="form-check d-flex justify-content-center">
                          <input
                            className="form-check-input"
